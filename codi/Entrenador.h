...
public:
    ...
    void ferSubstitucio(int dorsalSurt, int dorsalEntra, unique_ptr<rolAtacant> nouAtac, unique_ptr<rolDefensant> nouDef, const string &nomAtac, const string &nomDef);

    list<shared_ptr<Jugador>> JugadorsPista() const;
